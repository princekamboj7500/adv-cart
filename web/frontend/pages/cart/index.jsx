...
function Cart() { 
    ...
    const discountInputMarkup = (<Card.Section><FormLayout>
        ...
        />
        <DisplayText  size="small">Button color</DisplayText >
        <input type='color' value={setings.discount_input.button_color} onChange={(e) => handleDiscountInputFields("button_color")(e.target.value)} />
        {/* <ColorPicker 
        ...
        <input type='color' value={setings.discount_input.button_font_color} onChange={(e) => handleDiscountInputFields("button_font_color")(e.target.value)} />
        {/* <ColorPicker 
        ...
        <input type='color' value={setings.discount_input.label_color} onChange={(e) => handleDiscountInputFields("label_color")(e.target.value)} />
        ...
        <input type='color' value={setings.discount_input.label_font_color} onChange={(e) => handleDiscountInputFields("label_font_color")(e.target.value)} />
...
// const handleChangcheck = useCallback(
//   (newChecked: boolean) => setgiftChecked(newChecked),
//   [],
// );
const handleGiftpackInputFields = (index) => (e) => {
    setings["gift_packing"][index] = e;
    setSettings(setings => ({
        ...setings,
        ['gift_packing']: setings['gift_packing'],
    }));
    contentRef.contentWindow.postMessage(setings, "*");
}
    ...
    const handleCheckboxChange = (newChecked) => {
      ...
      console.log("nneewwchecckk", newChecked)
    //   setSettings(setings => ({
    //     ...setings,
    //     [newChecked]: setings.gift_packing['gift_checked'],
    // }));
    };
...
console.log("setttiinnggg", setings.gift_packing)
     const giftInputMarkup = (<Card.Section><FormLayout>
        ...
        <TextField
            label="Title Add Ons"
            onChange={handleGiftpackInputFields("gift_title_one")}
            autoComplete="off"
            value={setings.gift_packing.gift_title_one}
           
        />
        <TextField
            label="Title Add Ons"
            onChange={handleGiftpackInputFields("gift_title_two")}
            autoComplete="off"
            value={setings.gift_packing.gift_title_two}
        />
        <TextField
            label="Price"
            onChange={handleGiftpackInputFields("gift_price")}
            autoComplete="off"
    ...
    const [toggle2 , setToggle2] = useState(6)
    ...
    const mainPage = (<Layout>
        ...
        <div className='tog2_tabs'>
            <div className="head_tog2">
                <ul>
                    <li className={toggle2 === 6 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(6)}>Cart Template</li>
                    <li className={toggle2 === 7 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(7)}>Announcement</li>
                    <li className={toggle2 === 8 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(8)}>Shipping bar</li>
                    <li className={toggle2 === 9 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(9)}>Upsells</li>
                    <li className={toggle2 === 10 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(10)}>Add Ons</li>
                    <li className={toggle2 === 11 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(11)}>Additional notes</li>
                    <li className={toggle2 === 12 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(12)}>Discount Codes</li>
                    <li className={toggle2 === 13 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(13)}>Trust Badges</li>
                    <li className={toggle2 === 14 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(14)}>Express Payments</li>
                    <li className={toggle2 === 15 ?  "active_tab_blue" : "tab_black"} onClick={() => updatedToggle2(15)}>Settings</li>
                </ul>
            </div>
            <div className='tab_content_tog2'>
                <div className={toggle2 === 6 ?  "show_cont_tog2" : "cont_tog2"} >
                ...
                <div className={toggle2 === 7 ?  "show_cont_tog2" : "cont_tog2"}>
                    <Card
                ...
                <div className={toggle2 === 8 ?  "show_cont_tog2" : "cont_tog2"}>
                    <Card>
                        <Card.Header
                            actions={[]}
                ...
                <div className={toggle2 === 10 ?  "show_cont_tog2" : "cont_tog2"}>
                    <Card>
                        <Card.Header
                            ...
                            <Stack>
                                <Button
                                    primary={!setings['gift_input_status']}
                                    onClick={handleToggle('gift_input_status')}>{setings['gift_input_status'] ? 'Deactivate' : 'Activate'}</Button>
                            </Stack>
                        </Card.Header>
                        {setings['gift_input_status'] ? giftInputMarkup : <p>&nbsp;</p>}
                    </Card>
                </div>
                <div className={toggle2 === 11 ?  "show_cont_tog2" : "cont_tog2"} >
                    <Card>
                        <Card.Header
                            actions={[]}
                            title="Notes">
                ...
                <div className={toggle2 === 12 ?  "show_cont_tog2" : "cont_tog2"}>
                    <Card>
                        <Card.Header
                            actions={[]}
                ...
                <div className={toggle2 === 13 ?  "show_cont_tog2" : "cont_tog2"}>
                    <TrustPayment settings={setings} />
                </div>
                <div className={toggle2 === 14 ?  "show_cont_tog2" : "cont_tog2"}>
                    <Card>
                        <Card.Header
                            actions={[]}
                ...
                <div className={toggle2 === 15 ?  "show_cont_tog2" : "cont_tog2"}>
                    <Card>
                        <Card.Header
                            actions={[]}
    ...
    <div className='extra_cont_1'>
           ...
           <div className='extra_cont_1_hide'>
